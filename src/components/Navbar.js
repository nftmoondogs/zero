  ...
  return (
    <nav className="bg-black py-4">
      <div className="container mx-auto flex justify-between items-center px-4 xl:px-0">
        ...
        <div className="flex items-center">
          {/* Twitter Icon */}
          <a href="https://twitter.com/dielasoltoken" target="_blank" rel="noopener noreferrer" className="px-3">
          ...
          {/* Telegram Icon */}
          <a href="https://t.me/dielatoken" target="_blank" rel="noopener noreferrer" className="px-3">
            <svg className="fill-current text-red-600 hover:text-white" width="30" height="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
